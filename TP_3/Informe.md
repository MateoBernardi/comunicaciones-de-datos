...
| ------------------ | ------------- | --------------------------------|
| _Wi-FI_ | Sí | IEEE 802.11(ax,be) |
| _Bluetooth_ | Sí | IEEE 802.1.15 |
| _ZigBee_ | Sí | IEEE 802.15.4 |
| _NFC_ | Sí | ISO/IEC 18092:2019 |
| _LTE_ | Sí | 3GPP |
| _GSM_ | Sí | EDGE |
| _5G (#GPP)_ | Sí | 3GPP |
| _LoRa_ | Parcialmente | LoRaWAN 1.0.4 (sólo protocolo) |
| _NB-IoT_ | Sí | 3GPP |
| _SigFox_ | No | x |
| _Z-Ware_ | Sí | ITU-T G.9959 |
...
En conclusión, A2G es una solucion mucho menos costosa que ofrece una capacidad moderada con baja latencia en zonas limitadas son se tenga acceso a infraestructura terrestre.
Por otro lado, los servicios satelitales ofrecen una cobertura global, con una mejor capacidad de datos, pero a un costo muy superior.
Ademas los ultimos resultados de latencia para la red LEO (Low Earth Orbit) de Starlink revelaron valores menores al promedio de conexiones A2G.

b)
Revision del Paper:

##### **"First Look at Starlink In-Flight Performance: An Intercontinental Empirical Study"**
